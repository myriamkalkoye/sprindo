...
/**
 * Gestion des tâches en mémoire. - Structure : projetId -> sprintId -> liste de tâches - Valide les
 * champs obligatoires. - Garantit l'unicité de l'id par sprint.
 */
public class TacheImpl {
  ...
  public void changerStatut(
      String projetId, String sprintId, String tacheId, String nouveauStatut) {
